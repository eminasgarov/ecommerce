...
def register(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            profile.profile_picture = 'default/default-picture.jpg'
            profile.save()
            ...
            # messages.success(request, "We have sent verification email to you. Please, actvivate your account.")
        ...
        if user is not None:
            try:
                ...
                if is_cart_item_exist:
                    ...
                    cart_item = CartItem.objects.filter(user=user)        #cart item
                    ex_var_list = []
                    id = []
